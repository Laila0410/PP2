...
def insert_score(name, score, level): 
    conn = psycopg2.connect(dbname='lab10', user='postgres', password='postgres', host='localhost', port='5435') 
    cur = conn.cursor() 
...
def get_scores(name): 
    conn = psycopg2.connect(dbname='lab10', user='postgres', password='postgres', host='localhost', port='5432') 
    cur = conn.cursor() 
